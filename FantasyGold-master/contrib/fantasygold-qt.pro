...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/fantasygold-cli.cpp \
           src/fantasygold-tx.cpp \
           src/fantasygold.cpp \
           src/db.cpp \
           ...
           src/qt/fantasygold.cpp \
           src/qt/fantasygoldstrings.cpp \
...
RESOURCES += src/qt/fantasygold.qrc src/qt/fantasygold_locale.qrc

TRANSLATIONS += src/qt/locale/fantasygold_bg.ts \
                src/qt/locale/fantasygold_de.ts \
                src/qt/locale/fantasygold_en.ts \
                src/qt/locale/fantasygold_es.ts \
                src/qt/locale/fantasygold_fi.ts \
                src/qt/locale/fantasygold_fr.ts \
                src/qt/locale/fantasygold_it.ts \
                src/qt/locale/fantasygold_ja.ts \
                src/qt/locale/fantasygold_pl.ts \
                src/qt/locale/fantasygold_pt.ts \
                src/qt/locale/fantasygold_ru.ts \
                src/qt/locale/fantasygold_sk.ts \
                src/qt/locale/fantasygold_sv.ts \
                src/qt/locale/fantasygold_vi.ts \
                src/qt/locale/fantasygold_zh_CN.ts \
                src/qt/locale/fantasygold_zh_TW.ts
