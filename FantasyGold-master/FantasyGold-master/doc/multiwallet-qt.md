...
In order to support loading of multiple wallets in fantasygold-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fantasygold.cpp.
...
Changes to fantasygold.cpp
----------------------
fantasygold.cpp is the entry point into fantasygold-qt, and as such, will require some minor modifications to provide hooks for
