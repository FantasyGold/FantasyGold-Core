...
// Copyright (c) 2017-2017 The FantasyGold developers
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all FantasyGold specific functionality (Masternodes, Zerocoin, SwiftX, Budgeting) (0-1, default: %u)"), 0));
...
//    }
//
//    nAnonymizeFantasyGolldAmount = GetArg("-anonymizefantasygoldamount", 0);
