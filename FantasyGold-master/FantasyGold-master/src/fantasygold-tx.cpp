...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FantasyGold Core fantasygold-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fantasygold-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fantasygold transaction") + "\n" +
                               "  fantasygold-tx [options] -create [commands]   " + _("Create hex-encoded fantasygold transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fantasygold transaction
