...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/fantasygold-crypto/FantasyGold/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign FantasyGold Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit fantasygold=v${VERSION} ../fantasygold/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [fantasygold-detached-sigs](https://github.com/fantasygold-crypto/fantasygold-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/fantasygoldcoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/fantasygold-crypto/FantasyGold/releases/new) with a link to the archived release notes.
