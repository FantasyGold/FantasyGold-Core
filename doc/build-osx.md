...
1. Clone the FantasyGold Core source code:
    ```shell
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/FantasyGold"

touch "/Users/${USER}/Library/Application Support/FantasyGold/fantasygold.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/FantasyGold/fantasygold.conf"
```

The first time you run fantasygoldd, it will start downloading the blockchain. This process could
