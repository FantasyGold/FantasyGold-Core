...
1. Make sure you have the latest wallet version downloaded from our [Github](https://github.com/FantasyGold/FantasyGold-Core.git/releases) and the wallet is fully synced with atleast 100 FGC in each input. Also make sure that each input has atleast 475 confirmations.
