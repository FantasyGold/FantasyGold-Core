FantasyGold Core version 2.2.1 is now available from:

  <fantasygold/releases>
...
of Bitcoin that FantasyGold was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/fantasygold-project-translations/).
