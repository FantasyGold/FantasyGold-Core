...
The following new options are available for fantasygoldd and fantasygold-qt:
...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between fantasygoldd and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Sample initialization flow from _fantasygold-qt_ console (this needs to be done only once to set up the association):

 - Have KeePass running with an open database
 - Start _fantasygold-qt_
 - Open console
 - Type "_keepass init_" in fantasygold-qt console
 - Keepass pops up and asks for an association id, fill that in, for example, "_mydrkwallet_"
 - You should get a response like this "_Association successful. Id: mydrkwalletfantasygold - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _fantasygold.conf_ and fill in these values
```
keepass=1
