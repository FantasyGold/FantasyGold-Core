...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](FantasyGold/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone gitian.sigs.git
    git clone fantasygold-detached-sigs.git
...
- Detached signatures will then be committed to the [fantasygold-detached-sigs](fantasygold-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](FantasyGold/releases/new) with a link to the archived release notes.
