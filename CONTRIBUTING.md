Contributing to FantasyGold Core
============================

The FantasyGold Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FantasyGold Core project, and is not to be
confused with overall FantasyGold Network Protocol consensus changes.

Whether a pull request is merged into FantasyGold Core rests with the project merge
...
Patches that change FantasyGold consensus rules are considerably more involved than
...
Where a patch set proposes to change the FantasyGold consensus, it must have been
...
The project leader is the release manager for each FantasyGold Core release.
