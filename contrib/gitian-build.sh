...
VERSION=
commit=false
url=https://github.com/FantasyGold/FantasyGold-Core.git
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/FantasyGold/FantasyGold-Core.git
