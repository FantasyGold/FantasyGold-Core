...
CONFIG_HEADER = $(top_builddir)/src/config/fantasygold-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/fantasygold-config.h.in \
...
ACLOCAL = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = fantasygold
PACKAGE_BUGREPORT = bugreport@draftdaily.com
PACKAGE_NAME = FantasyGold Core
PACKAGE_STRING = FantasyGold Core 1.0.0
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/silence/devfsg/Fangold/FantasyGold
abs_srcdir = /home/silence/devfsg/Fangold/FantasyGold
abs_top_builddir = /home/silence/devfsg/Fangold/FantasyGold
abs_top_srcdir = /home/silence/devfsg/Fangold/FantasyGold
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/silence/devfsg/Fangold/FantasyGold/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/fantasygoldd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/fantasygold-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/fantasygold-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_fantasygold_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_fantasygold_coverage.info test_fantasygold.info
...
src/config/fantasygold-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/fantasygold-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/fantasygold-config.h
$(top_srcdir)/src/config/fantasygold-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/fantasygold-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/FantasyGold-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#test_fantasygold.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_fantasygold -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_fantasygold_filtered.info: test_fantasygold.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_fantasygold_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_fantasygold_coverage.info: baseline_filtered_combined.info test_fantasygold_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_fantasygold_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_fantasygold_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_fantasygold_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_fantasygold.coverage/.dirstamp:  test_fantasygold_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_fantasygold.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_fantasygold.coverage/ total.coverage/ $(OSX_APP)
