...
#if defined(NDEBUG)
#error "Fantasy Gold Core cannot be compiled without assertions."
#endif
...
{
	int64_t nSubsidy = 0;
	int nSubsidyDecreasePeriod, nSubsidyPeriod, i;
	...
	if (Params().NetworkID() == CBaseChainParams::TESTNET) {
		int nDecreasePeriodTestnet, nSubsidyPeriodTestnet, i;
