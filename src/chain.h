...
public:
    ...
    explicit CBlockIndex(const CBlockHeader& block)
    {
        ...
        nNonce         = block.nNonce;
        nMoneySupply   = 0;
        hashStateRoot  = block.hashStateRoot; // fantasygold
        hashUTXORoot   = block.hashUTXORoot; // fantasygold
        nStakeModifier = uint256();
        hashProof = uint256(); 
    ...
    bool IsProofOfWork() const // fantasygold
    {
