...
#define paternVersion "fantasygold-([0-9]+\\.)?([0-9]+\\.)?([0-9]+)-"

FantasyGoldVersionChecker::FantasyGoldVersionChecker(QObject *parent) : QObject(parent)
{
    currentVersion = Version(CLIENT_VERSION_MAJOR, CLIENT_VERSION_MINOR, CLIENT_VERSION_REVISION);
}

FantasyGoldVersionChecker::~FantasyGoldVersionChecker()
{

}

bool FantasyGoldVersionChecker::newVersionAvailable()
{
...
Version FantasyGoldVersionChecker::getMaxReleaseVersion()
{
