    ...
    m_results(1)
{
    ...
    ui->labelAmount->setToolTip(tr("The amount in FANTASYGOLD to send. Default = 0."));
    ui->labelSenderAddress->setToolTip(tr("The fantasygold address that will be used as sender."));
