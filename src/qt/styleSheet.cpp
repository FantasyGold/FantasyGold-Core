...
void StyleSheet::setStyleSheet(QApplication *app, const QString& style_name)
{
    ...
    FantasyGoldStyle* fantasygoldStyle = new FantasyGoldStyle;
    fantasygoldStyle->setBaseStyle(mainStyle);
    app->setStyle(fantasygoldStyle);
...
{
    return QStringList() << "Light gray theme" << "Dark blue theme" << "Dark theme";
}
