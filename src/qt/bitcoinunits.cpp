...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits() {
    ...
    unitlist.append(FGC);
    unitlist.append(mFGC);
    unitlist.append(uFGC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit) {
    switch (unit) {
    case FGC:
        return QString("fantasygold");
    case mFGC:
        return QString("mfantasygold");
    case uFGC:
        return QString::fromUtf8("ufantasygold");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit) {
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case FGC:
            return QString("tFGC");
        case mFGC:
            return QString("mtFGC");
        case uFGC:
            return QString::fromUtf8("μtFGC");
        default:
            return QString("???");
        }
    }
