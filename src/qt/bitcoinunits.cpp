...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FANTASYGOLD");
    case mBTC: return QString("mFANTASYGOLD");
    case uBTC: return QString::fromUtf8("μFANTASYGOLD (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FantasyGolds");
    case mBTC: return QString("Milli-FantasyGolds (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-FantasyGolds (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
