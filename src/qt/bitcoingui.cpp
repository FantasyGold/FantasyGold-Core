...
#include <qt/fantasygoldversionchecker.h>
    ...
    m_network_style(networkStyle)
{
    ...
    fantasygoldVersionChecker = new FantasyGoldVersionChecker(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FantasyGold address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fantasygold: URIs)"));
    ...
    FGCTokenAction = new QAction(platformStyle->MultiStatesIcon(":/icons/fgctoken"), tr("&FGC Tokens"), this);
    FGCTokenAction->setStatusTip(tr("FGC Tokens (send, receive or add Tokens in list)"));
    FGCTokenAction->setToolTip(FGCTokenAction->statusTip());
    FGCTokenAction->setCheckable(true);
    FGCTokenAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(FGCTokenAction);
    ...
    connect(FGCTokenAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(FGCTokenAction, SIGNAL(triggered()), this, SLOT(gotoTokenPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FantasyGold addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FantasyGold addresses"));
    ...
    openAction->setStatusTip(tr("Open a fantasygold: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible FantasyGold command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        appNavigationBar->addAction(FGCTokenAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    FGCTokenAction->setEnabled(enabled);
...
{
    FGCTokenAction->setChecked(true);
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to FantasyGold network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
