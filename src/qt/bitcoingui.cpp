                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FantasyGold Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview_m"), tr("&Overview"), this);
    ...
    historyAction = new QAction(QIcon(":/icons/history_m"), tr("&Transactions"), this);
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFGC"));
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes_m"), tr("&Masternodes"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FantasyGold Core"), this);
    aboutAction->setStatusTip(tr("Show information about FantasyGold Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FantasyGold"));
    ...
    openInfoAction = new QAction(QIcon(":/icons/information"), tr("&Information"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the FantasyGold Core help message to get a list with possible FantasyGold command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FantasyGold Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FantasyGold network", "", count));
}
...
{
    QString strTitle = tr("FantasyGold Core"); // default title
