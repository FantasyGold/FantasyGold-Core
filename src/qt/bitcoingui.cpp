...
void BitcoinGUI::createActions()
{
    ...
    FGCTokenAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    ...
    openAction->setStatusTip(tr("Open a fantasygold: URI or payment request"));//FGC_LINE

    showHelpMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible FantasyGold command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        appNavigationBar->mapGroup(FGCTokenAction, tokenActions);
...
{
    QString strTitle = tr("FantasyGold"); // default title
