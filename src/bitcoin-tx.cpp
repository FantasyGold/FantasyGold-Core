...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fantasygold-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fantasygold-tx [options] <hex-tx> [commands]  Update hex-encoded fantasygold transaction\n" +
            "or:     fantasygold-tx [options] -create [commands]   Create hex-encoded fantasygold transaction\n" +
            "\n";
