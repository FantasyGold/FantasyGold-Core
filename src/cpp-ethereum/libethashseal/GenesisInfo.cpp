...
#include "genesis/fantasygoldMainNetwork.cpp"
#include "genesis/fantasygoldTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::fantasygoldMainNetwork: return c_genesisInfoFantasyGoldMainNetwork;
	case Network::fantasygoldTestNetwork: return c_genesisInfoFantasyGoldTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::fantasygoldMainNetwork: return c_genesisStateRootFantasyGoldMainNetwork;
	case Network::fantasygoldTestNetwork: return c_genesisStateRootFantasyGoldTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
