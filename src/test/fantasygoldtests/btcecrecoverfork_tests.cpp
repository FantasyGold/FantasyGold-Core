...
BOOST_AUTO_TEST_CASE(checking_btcecrecover_after_fork){
    ...
    std::vector<FantasyGoldTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createFantasyGoldTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFantasyGoldTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFantasyGoldTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createFantasyGoldTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
