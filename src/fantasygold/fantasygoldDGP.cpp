...
void FantasyGoldDGP::initDataEIP158(){
...
bool FantasyGoldDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData){
...
dev::eth::EVMSchedule FantasyGoldDGP::getGasSchedule(unsigned int blockHeight){
    clear();
...
dev::eth::EVMSchedule FantasyGoldDGP::createEVMSchedule(){
    dev::eth::EVMSchedule schedule = dev::eth::EIP158Schedule;
