#ifndef FANTASYGOLDDELEGATION_H
#define FANTASYGOLDDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IFantasyGoldStaker class Delegation filter
 */
...
/**
 * @brief The FantasyGoldDelegation class Communicate with the fantasygold delegation contract
 */
class FantasyGoldDelegation {
    
public:
    /**
     * @brief FantasyGoldDelegation Constructor
     */
    FantasyGoldDelegation();

    /**
     * @brief ~FantasyGoldDelegation Destructor
     */
    virtual ~FantasyGoldDelegation();
...
private:
    FantasyGoldDelegation(const FantasyGoldDelegation&);
    FantasyGoldDelegation& operator=(const FantasyGoldDelegation&);
    FantasyGoldDelegationPriv* priv;
};
#endif
