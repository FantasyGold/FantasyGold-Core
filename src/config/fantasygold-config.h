/* src/config/fantasygold-config.h.  Generated from fantasygold-config.h.in by configure.  */
/* src/config/fantasygold-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "bugreport@draftdaily.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FantasyGold Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FantasyGold Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fantasygold"
