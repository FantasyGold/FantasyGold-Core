...
static const CRPCCommand vRPCCommands[] =
    ...
    {"fantasygold", "listmasternodes", &listmasternodes, true, true, false},
        {"fantasygold", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fantasygold", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fantasygold", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
    ...
    {"fantasygold", "getpoolinfo", &getpoolinfo, true, true, false},
        {"fantasygold", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
    /* Wallet */
    ...
    {"zerocoin", "reconsiderzerocoins", &reconsiderzerocoins, false, false, true},
        ...
        {"zerocoin", "getzfgcseed", &getzfgcseed, false, false, true},
        {"zerocoin", "setzfgcseed", &setzfgcseed, false, false, true}
...
std::string HelpExampleCli(string methodname, string args) {
    return "> fantasygold-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(string methodname, string args) {
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:57814/\n";
}
