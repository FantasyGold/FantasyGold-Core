...
UniValue getinfo(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total fantasygold balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zFGCsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zFGC denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zFGC denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zFGC denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zFGC denomination\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in fantasygold/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in fantasygold/kb\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"fantasygoldaddress\"     (string, required) The fantasygold address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are fantasygold addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) fantasygold address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"fantasygoldaddress\"  (string, required) The fantasygold address to use for the signature.\n"
