...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        READWRITE(nBits);
        READWRITE(nNonce);
        READWRITE(hashStateRoot); // fantasygold
        READWRITE(hashUTXORoot); // fantasygold
...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // fantasygold
        hashUTXORoot.SetNull(); // fantasygold
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //fantasygold
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //fantasygold
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //fantasygold
    {
