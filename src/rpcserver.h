...
/**
 * FantasyGold RPC command dispatcher.
 */
class CRPCTable {
  private:
...
extern UniValue setzfgcseed(const UniValue& params, bool fHelp);
extern UniValue getzfgcseed(const UniValue& params, bool fHelp);
