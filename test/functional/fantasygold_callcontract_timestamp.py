...
from test_framework.fantasygold import activate_mpos
...
class FantasyGoldCallContractTimestampTest(BitcoinTestFramework):
...
if __name__ == '__main__':
    FantasyGoldCallContractTimestampTest().main()
