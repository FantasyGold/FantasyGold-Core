...
"""
Note, these tests do not test the functionality of the DGP template contract itself, for tests for the DGP template, see fantasygold-dgp.py
"""
class FantasyGoldDGPActivation(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Restart the fantasygoldd to verify that no crashes occurs on startup
        self.stop_nodes()
        self.start_nodes()


if __name__ == '__main__':
    FantasyGoldDGPActivation().main()
