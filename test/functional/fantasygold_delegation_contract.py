...
class FantasyGoldSimpleDelegationContractTest(BitcoinTestFramework):
    ...
    """
        - Check that it is not possible to use an input with less value than 100 fantasygold as the first input to the coinstake.
        - Check that 100 fantasygold is just enough for the first input to the coinstake.
    """
    def nas_staker_must_be_100_fantasygold_test(self):
    ...
    def run_test(self):
        ...
        print("nas_staker_must_be_100_fantasygold_test")
        self.nas_staker_must_be_100_fantasygold_test()
        self.sync_all()
...
if __name__ == '__main__':
    FantasyGoldSimpleDelegationContractTest().main()
