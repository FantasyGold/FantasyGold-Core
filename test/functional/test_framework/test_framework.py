...
from .fantasygoldconfig import COINBASE_MATURITY
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def main(self):
        ...
        self.options.bitcoind = os.getenv("BITCOIND", default=config["environment"]["BUILDDIR"] + '/src/fantasygoldd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("BITCOINCLI", default=config["environment"]["BUILDDIR"] + '/src/fantasygold-cli' + config["environment"]["EXEEXT"])
    ...
    def enable_mocktime(self):
        ...
        2014 + (201 * 10 * 60)"""
        self.mocktime = 1561658908 + (601 * 2 * 64) # int(time.time()) - 100*24*60*60 + (201 * 10 * 60)
        ...
        if create_cache:
            ...
            for i in range(MAX_NODES):
                ...
                for entry in os.listdir(cache_path(i)):
                    if entry not in ['chainstate', 'blocks', 'stateFantasyGold']:
