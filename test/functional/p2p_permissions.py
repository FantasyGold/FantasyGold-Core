...
from test_framework.fantasygold import convert_btc_bech32_address_to_fantasygold
...
class P2PPermissionsTests(BitcoinTestFramework):
    ...
    def check_tx_relay(self):
        block_op_true = self.nodes[0].getblock(self.nodes[0].generatetoaddress(COINBASE_MATURITY+1, convert_btc_bech32_address_to_fantasygold(ADDRESS_BCRT1_P2WSH_OP_TRUE))[0])
        self.sync_all()
        ...
        tx = FromHex(
            ...
            self.nodes[0].createrawtransaction(
                inputs=[{
                    ...
                    convert_btc_bech32_address_to_fantasygold(ADDRESS_BCRT1_P2WSH_OP_TRUE): 5,
                }]),
        )
